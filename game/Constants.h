...
namespace ApplesGame
{
	...
	const int MODE_20_APPLES = 1;        // 1 = 20 €блок
	const int MODE_50_APPLES = 2;        // 2 = 50 €блок
	const int MODE_ACCELERATION = 4;     // 4 = ускорение
	const int MODE_INFINITE_APPLES = 8;  // 8 = бесконечные €блоки
}